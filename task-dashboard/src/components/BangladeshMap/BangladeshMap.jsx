...
const GEO_JSON_URL = "/bangladesh_geojson_adm2_64_districts_zillas.json";
...
export default function BangladeshMap() {
  ...
  useEffect(() => {
    setHighlightedDistricts(Object.keys(districtData));
  }, [districtData]);

  const handleMouseEnter = (district, event) => {
    setHoveredDistrict(districtData[district] || `District: ${district}`);
